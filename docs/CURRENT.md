...
- PR #43's synthetic live-Postgres trace (recognition 5/5 versus production 2/5) confirms that the aggregate mechanism clears a 0.60 gap correctly; it does not validate the provisional 0.40 threshold or five-observation floor, which still require real pilot calibration.
